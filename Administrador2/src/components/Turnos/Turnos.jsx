            ...
            <div className="row ">
                ...
                <div className="col-md-8 p-0  d-flex flex-column">
                    ...
                    <div className="bg-secondary" style={{ height: "80%" }} >
                       ...
                       <Image src='https://firebasestorage.googleapis.com/v0/b/vidanuevasystem-0.appspot.com/o/Pollo%20loocjpg.jpg?alt=media&token=f1e06f9e-ac39-455e-af03-0edeee66e26e' width="100%" height={610} duration={0} fit="cover" />                        
